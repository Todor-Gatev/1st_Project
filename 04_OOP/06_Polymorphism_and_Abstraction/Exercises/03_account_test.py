...
class Account:
    ...
    def __handle_transaction(self, transaction_amount) -> str:
    ...
    def add_transaction(self, amount: int) -> str:
        ...
        return self.__handle_transaction(amount)
    ...
    def __add__(self, other):
        ...
        new_account._transactions = self.transactions + other.transactions
