...
class Expression:
    ...
    def resize(self, width, height, x, y):
        ...
        self.state.resize(width * 0.1, height * 0.7)
        self.state.move(width * 0.02, height * 0.15)

        self.equal_label.resize(width * 0.04, height * 0.7)
        self.equal_label.move(width * 0.13, height * 0.15)

        if self.negate:
            self.first_bracket.resize(width * 0.04, height * 0.7)
            self.first_bracket.move(width * 0.16, height * 0.15)
        else:
            self.first_bracket.resize(width * 0.03, height * 0.7)
            self.first_bracket.move(width * 0.17, height * 0.15)

        self.first_bool.resize(width * 0.1, height * 0.7)
        self.first_bool.move(width * 0.2, height * 0.15)

        self.first_operator.resize(width * 0.04, height * 0.7)
        self.first_operator.move(width * 0.31, height * 0.15)

        self.second_bool.resize(width * 0.1, height * 0.7)
        self.second_bool.move(width * 0.36, height * 0.15)

        self.second_bracket.resize(width * 0.03, height * 0.7)
        self.second_bracket.move(width * 0.46, height * 0.15)

        self.second_operator.resize(width * 0.04, height * 0.7)
        self.second_operator.move(width * 0.5, height * 0.15)

        self.third_bracket.resize(width * 0.03, height * 0.7)
        self.third_bracket.move(width * 0.55, height * 0.15)

        self.third_bool.resize(width * 0.1, height * 0.7)
        self.third_bool.move(width * 0.58, height * 0.15)

        self.third_operator.resize(width * 0.04, height * 0.7)
        self.third_operator.move(width * 0.69, height * 0.15)

        self.fourth_bool.resize(width * 0.1, height * 0.7)
        self.fourth_bool.move(width * 0.74, height * 0.15)

        self.fourth_bracket.resize(width * 0.03, height * 0.7)
        self.fourth_bracket.move(width * 0.84, height * 0.15)
