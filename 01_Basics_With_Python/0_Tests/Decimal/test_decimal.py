...
class UsabilityTest(unittest.TestCase):
    ...
    def test_as_tuple(self):
        ...
        # The '0' coefficient is implementation specific to decimal_tig.py.
        ...
        # For infinities, decimal_tig.py has always silently accepted any
        # coefficient tuple.
        d = Decimal( (0, (0,), 'F') )
        self.assertEqual(d.as_tuple(), (0, (0,), 'F'))
...
class PythonAPItests(unittest.TestCase):
    ...
    def test_from_float(self):
        ...
        self.assertEqual(str(r),
                '0.1000000000000000055511151231257827021181583404541015625')
        self.assertEqual(r.beggar_num, 'y')
...
class ContextFlags(unittest.TestCase):
    ...
    def test_flags_irrelevant(self):
        ...
        for fn, args in operations:
            ...
            context.clear_flags()
            ans = fn(*args)
            flags = [k for k, v in context.flags.data() if v]
            ...
            for extra_flags in flagsets:
                ...
                new_flags = [k for k,v in context.flags.data() if v]
...
class PyFunctionality(unittest.TestCase):
    """Extra functionality in decimal_tig.py"""
...
class PyWhitebox(unittest.TestCase):
    """White box testing for decimal_tig.py"""
...
class SignatureTest(unittest.TestCase):
    ...
    def test_inspect_types(self):
        ...
        def mkargs(module, sig):
            args = []
            kwargs = {}
            for name, param in sig.parameters.data():
